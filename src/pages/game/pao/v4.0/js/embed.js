...
Embed.prototype.singleExp = function (type) {
  ...
  switch (type) {
    ...
    case Embed.TYPE_15:
      ...
      break;
    case Embed.TYPE_16:
      item = this.data.st_info_exposure_auto_start;
      break;
    default:
      item = null;
      break;
...
Embed.prototype.singleClk = function (type) {
  ...
  switch (type) {
    ...
    case Embed.TYPE_15:
      ...
      break;
    case Embed.TYPE_16:
      item = this.data.st_info_click_auto_start;
      break;
    default:
      item = null;
      break;
 ...
 * @param {埋点编号} aim 
 */
Embed.prototype.numClick = function(aim){
  var data = this.data;
  for(var i in data){
      var d = data[i];
      if((d.dpm === d.appId + ".115." + aim) || (d.dpm === d.appId + ".131." + aim)){
...
* @param {埋点编号} aim 
*/
Embed.prototype.numExport = function(aim){
  var data = this.data;
  for(var i in data){
      var d = data[i];
      if((d.dpm === d.appId + ".115." + aim) || (d.dpm === d.appId + ".131." + aim)){
