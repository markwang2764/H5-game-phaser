...
function phgameInit(){
    ...
    phgame = new Phaser.Game(STAGE_WIDTH, STAGE_HEIGHT, Phaser.CANVAS, 'phaser', { preload: preload, create: create, render: render}, true);
}
...
function preload() {
    ...
    phgame.load.image('treasureBoxMonster', CFG.treasureBoxMonster);
    phgame.load.image('treasureBox', CFG.treasureBox);
...
function create() {
    ...
    phbox = new PhBox([-1, 1, -1], [phrows[0].y, phrows[1].y, phrows[2].y]);
    phviews.push(phbox);
