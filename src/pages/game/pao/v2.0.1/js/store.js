function Store(callback){
    ...
    this.boss = this.getBoss(CFG.monsters);
...
Store.prototype.getBackground = function(data){
    if(this.noneData(data)){
        data = "//yun.tuisnake.com/h5-mami/webgame/fish/bg.png";
    }
    return data;
}
...
Store.prototype.getBanner = function(data){
    if(this.noneData(data)){
        data = "//yun.tuisnake.com/h5-mami/webgame/fish/banner.png";
    }
    return data;
}
...
Store.prototype.getGuns = function(data){
    if(this.noneData(data)){
        ...
        data = [
            {
                "type": 10,
                "url": "//yun.tuisnake.com/h5-mami/webgame/fish/pao-10.png"
            },
            {
                "type": 100,
                "url": "//yun.tuisnake.com/h5-mami/webgame/fish/pao-100.png"
            },
            {
                "type": 1000,
                "url": "//yun.tuisnake.com/h5-mami/webgame/fish/pao-1000.png"
            }
        ]
        */
        data = [100, 200, 300];
...
Store.prototype.getMonsters = function(data){
    if(this.noneData(data)){
        ...
        data = data.filter(function(item){
            return item.monsterType == 0;
        });
    }
    return data;
}

Store.prototype.getBoss = function(data){
    var list = JSON.parse(data);
    list = list.filter(function(item){
        return item.monsterType == 1;
    });
    return list[0];
}
