...
function preload() {
    ...
    phgame.load.bitmapFont('num', '//yun.tuisnake.com/h5-mami/webgame/fish/num8-export.png', '//yun.tuisnake.com/h5-mami/webgame/fish/num8-export.xml', null, 0);
    phgame.load.bitmapFont('comboxfont', '//yun.tuisnake.com/h5-mami/webgame/fish/combox-export8.png', '//yun.tuisnake.com/h5-mami/webgame/fish/combox-export8.xml', null, 0);
...
function create() {
    ...
    // var goldText = phgame.add.bitmapText(100, 200, 'num', 'haha', 64);
    // goldText.setText("$1.7205621355768316$");
    // var runText = true;
    // var goldCounter = 0;
    // var gold_max = 1.72;
    // var stepGold = 0.1;
    ...
    // function updateText() {
	// 	if(!runText) return;
    //     goldCounter += stepGold;
    //     console.log(goldCounter);
	// 	if(goldCounter >= gold_max){
	// 		this.goldCounter = gold_max;
	// 		runText = false;
	// 	}
		
    //     goldText.setText(Number(goldCounter).toFixed(2) + "$");
    // }
}
