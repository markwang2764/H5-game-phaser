...
class GameRoom extends EventEmitter {
  ...
  showQiandai(num){
    ...
    var html = jtemp.build({num: num});
    $(".qiandai-content").html(html).show().removeClass("fadeOut");;
