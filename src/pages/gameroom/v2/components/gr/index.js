...
import WelcomePop from '../../../components/welpop/v3.1/index';
    ...
    for (var i = 0; i < type.blocks.length; i++) {
      ...
      switch (type.regionType) {
        ...
        case RegionType.Icon:
          ...
          if (i == 0) {
            playNum = utils.tostring(showNum) + '人在玩';

            html += `<a data-index="1" data-href="${
              t_blocks.url
              }">
            <div class="paoitem">
              <div class="item-3314257"></div>
              <div class="item-3333215"></div>
              <div class="item-3401959">
                  <div class="hotgame-title">${playNum}</div>
              </div>
              <div class="item-guangmask">
                  <div class="item-guangxian"></div>
              </div>
              <div class="item-3432679"></div>
              <div class="item-3437799"></div>
              <div class="item-3442111"></div>
              <div class="item-3445135"></div>
            </div>
            </a></li>`;
          } else {
            html += `<a data-href="${
